...
app.get("/", async (req, res) => {
  try {
    res.sendFile(__dirname + "/index.html"); //defining the route folder of the index .html and here wherever we deployed this this path will help to locate the index.html file
  } catch (error) {
